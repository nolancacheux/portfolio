...
- **Prophet** - Facebook's time-series forecasting library for multi-output predictions
...
|----------|-------------|
| **ML** | Prophet, scikit-learn, joblib |
| **Data** | PySpark, Delta Lake, Pandas, NumPy |
| **MLOps** | Databricks, MLflow, Databricks Bundles |
| **Cloud** | AWS S3, CodeArtifact, ECR |
