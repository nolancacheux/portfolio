...
summary: "Enterprise GenAI chatbot for Decathlon Finance, saving 13,000 hours/year for the suppliers team. Built with LangGraph, Google Gemini, and RAG architecture on GCP infrastructure."
images:
...
| **Integrations** | Connected to eOne, ORGA DAF, Nomenclature |
| **Escalation** | Automatic redirection to accountants when needed |

The chatbot eliminates repetitive questions about supplier processes, freeing up the finance team to focus on high-value tasks while ensuring consistent, accurate answers aligned with internal procedures.
