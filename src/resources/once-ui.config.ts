...
const baseURL: string = "https://nolancacheux.vercel.app";
...
// LinkedIn-inspired styling with professional blue theme
const style: StyleConfig = {
  theme: "dark", // dark | light | system
  neutral: "slate", // sand | gray | slate | custom
  brand: "blue", // LinkedIn blue - blue | indigo | violet | magenta | pink | red | orange | yellow | moss | green | emerald | aqua | cyan | custom
